...
# Load saved index and search it; all these steps are required to make it the right type...
o = cv.flann_Index()
mytype = type(o)
flann = mytype()
flann.load(des_t,'p128_des_large_idx.obj')
...
oriimg = cv.imread('../VDMSDataset/dataset/img/surface7.jpg')
