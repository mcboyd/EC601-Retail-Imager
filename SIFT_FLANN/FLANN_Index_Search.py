...
file_des = open('p128_des_'+indexFile+'.obj', 'rb')  # SIFT obj of features
...
mytype = type(o)
flann = mytype()
flann.load(des_t,'p128_des_'+indexFile+'_idx.obj')  # Insert index object file name here


# Setup SIFT feature extraction process
sift = cv.xfeatures2d.SIFT_create()

oriimg = cv.imread('../VDMSDataset/dataset/img/'+inputImg)  # Populate with image to search for
